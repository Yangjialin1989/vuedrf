          ...
          <el-main>
            ...
            <el-table :data="data1" border style="width: 100%;" flexible>
              ...
              <el-table-column label="操作" width="140" fixed="right">
                <el-button @click="viewStudent()" type="success" :icon="MoreFilled" circle size="small"/>
                <el-button type="primary" :icon="Message" circle size="small"/>
            ...
            <el-dialog title="学生明细" v-model="dialogVisible" width="50%" :close-on-click-modal="false">
              <el-form :inline="true" size="small" label-width="110px" label-position="right" style="margin-left: 20px;">
                <el-form-item label="学号:">
                  <el-input suffix-icon="EditPen" ></el-input>
                </el-form-item>
                <el-form-item label="姓名:">
                  <el-input suffix-icon="EditPen" ></el-input>
                </el-form-item>
                <el-form-item label="性别:">
                  <el-select placeholder="Select" style="width:188px;"  size="small">
                    <el-option label="男" value="男"></el-option>
                    <el-option label="女" value="女"></el-option>
                  </el-select>
                </el-form-item>
                <el-form-item label="生日:">
                  <el-date-picker type="date" placeholder="请选择日期" style="width: 100%;">
                  </el-date-picker>
                </el-form-item>
